...
{
    /// <summary>The id prefix for VOD category channel items.</summary>
    public const int VodCategoryPrefix = 0x6d774c35;

    /// <summary>The id prefix for stream channel items.</summary>
    public const int StreamPrefix = 0x6d774c36;

    /// <summary>The id prefix for series category channel items.</summary>
    public const int SeriesCategoryPrefix = 0x6d774c37;

    /// <summary>The id prefix for series channel items.</summary>
    public const int SeriesPrefix = 0x6d774c38;

    /// <summary>The id prefix for season channel items.</summary>
    public const int SeasonPrefix = 0x6d774c39;

    /// <summary>The id prefix for episode channel items.</summary>
    public const int EpisodePrefix = 0x6d774c3a;

    /// <summary>The id prefix for catchup channel items.</summary>
    public const int CatchupPrefix = 0x6d774c3b;

    /// <summary>The id prefix for catchup stream items.</summary>
    public const int CatchupStreamPrefix = 0x6d774c3c;

    /// <summary>The id prefix for media source items.</summary>
    public const int MediaSourcePrefix = 0x6d774c3d;

    /// <summary>The id prefix for Live TV items.</summary>
    public const int LiveTvPrefix = 0x6d774c3e;

    /// <summary>The id prefix for TV EPG items.</summary>
    public const int EpgPrefix = 0x6d774c3f;
    ...
    /// <summary>
    /// Gets a channel item info for the category.
    /// </summary>
    ...
    /// <summary>
    /// Matches tags in brackets [TAG] or pipe-delimited |TAG|.
    /// </summary>
    [GeneratedRegex(@"\[([^\]]+)\]|[|│┃｜]\s*([^|│┃｜]+?)\s*[|│┃｜]")]
