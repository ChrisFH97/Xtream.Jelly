export default function (view) {
  view.addEventListener("viewshow", () => import(
    ...
    XJ.populateCategoriesTable(
      ...
      () => XJ.fetchJson('XtreamJelly/VodCategories'),
      (categoryId) => XJ.fetchJson(`XtreamJelly/VodCategories/${categoryId}`),
    ).then((data) => {
      view.querySelector('#XJVodForm').addEventListener('submit', (e) => {
